...
struct job_queue {
    void **buffer;             // array af void* jobs
    int capacity;              // max antal jobs
    int count;                 // nuværende antal jobs
    int front;                 // index for næste pop
    int rear;                  // index for næste push
    int destroyed;             // flag når destroy kaldes
